...
# modified and added more tweets by @Murat_30_kaal for kaalbot.....
# added sudo support by @Murat_30_kaal
# family completed.....
...
async def nope(aura):
    ...
    if not kaal:
        if aura.is_reply:
            ...
            return
    tweeter = await bot.inline_query("TwitterStatusBot", f"{(deEmojify(kaal))}")
