...
@kaalBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="cos ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="tan ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="sec ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="cot ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="square ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="cube ?(.*)"))
@kaakBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
