...
@kaalBOT.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@kaalBOT.on(admin_cmd(pattern="unfban ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@kaalBOT.on(admin_cmd(pattern=r"fadd ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern=r"fremove ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="fgroups"))
@kaalBOT.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="fsearch ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@kaalBOT.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@kaalBOT.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@kaalBOT.on(admin_cmd(pattern="renamefed ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    kaal_input = event.pattern_match.group(1)
...
@kaalBOT.on(admin_cmd(pattern="fstat ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await kaalBOT.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using kaalBOT](t.me/kaalsupport01) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await kaal.edit("`Please Unblock` @MissRose_Bot")


@kaalBOT.on(admin_cmd(pattern="fedinfo ?(.*)"))
@kaalBOT.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    kaal = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await kaal.edit(massive.text + "\n\n**LEGENDARY_AF_kaalBOT**")
        except YouBlockedUserError:
            await kaal.edit("`Please Unblock` @MissRose_Bot")
