...
from kaalBOT.utils import admin_cmd, sudo_cmd, errors_handler
from userbot import bot as kaalBOT
from userbot import BOTLOG, BOTLOG_CHATID


@kaalBOT.on(admin_cmd(outgoing=True, pattern="del$"))
@kaalBOT.on(sudo_cmd(allow_sudo=True, pattern="del$"))
@errors_handler
