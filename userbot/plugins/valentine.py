...
@kaalBOT.on(admin_cmd(pattern="vday$"))
@kaalBOT.on(sudo_cmd(pattern="vday$", allow_sudo=True))
async def gif(event):
    if event.fwd_from:
        return
    ...
    if x == 1:
        await event.edit(f"My love for you \nSets my heart on fire \nand makes each day of my life \nSo special \n\n [✍️](https://telegra.ph/file/688abc98761f031128b9b.jpg) {kaal}", link_preview=True)
    if x == 2:
        await event.edit(f"What I Need to live \nhas been given to me \nby the earth. Why I need \nto live has been given to\nme by you \n\n [✍️](https://telegra.ph/file/b6ab919f97283fc0d8c39.jpg) {kaal}", link_preview=True)
    if x == 3:
        await event.edit(f"I Loved You Yesterday\n      I Love You Still\nI Always Have... \n       I Always Will\n\n [✍️](https://telegra.ph/file/d889a29342b97ecc1327a.jpg) {kaal}", link_preview=True)
    if x == 4:
        await event.edit(f"My Days And Nights \nAre spent thinking of you \nMy dreams have come true\nNow that you are in my life\n\n [✍️](https://telegra.ph/file/9c63c4ae22c5353c0e681.jpg) {kaal}", link_preview=True)
    if x == 5:
         await event.edit(f"I will always be \nthere for you, \nwill you be there \nfor me...\n\n [✍️](https://telegra.ph/file/1d335e658d16be01c0453.jpg) {kaal}", link_preview=True)
    if x == 6:
        await event.edit(f"If I never MET you, I wouldn't LIKE you. \nIf I didn't LIKE you, I wouldn't LOVE you. \nIf I didn't LOVE you, I wouldn't MISS you. \n   **BUT I DID, I DO, AND I WILL... **\n\n [✍️](https://telegra.ph/file/0cda352205a74b1498cff.jpg) {kaal}", link_preview=True)
    if x == 7:
        await event.edit(f"Thinking of you! \nDreaming of You! \nHugging you! \nMissing you! \nWishing you! \nI Love You! \n\n [✍️](https://telegra.ph/file/90554d3c4169a8cb8d04e.jpg) {kaal}", link_preview=True)
    if x == 8:
        await event.edit(f"Anyone can catch your eye \nBut it takes \nSomeone special \nto catch your heart\n\n [✍️](https://telegra.ph/file/4b9d922e701a7184d098b.jpg) {kaal}", link_preview=True)
    if x == 9:
        await event.edit(f"I love your warm smile \nAnd your kind, thoughtful way, \nLove the joy that you bring \nTo my life every day.\n\n [✍️](https://telegra.ph/file/e3d4401a919d8d81be4d4.jpg) {kaal}", link_preview=True)
    if x == 10:
        await event.edit(f"I feel the happiest \nwhen I think about you \ncoz I love you. \nHappy Valentine’s Day!\n\n [✍️](https://telegra.ph/file/5e42aae4ad6b80cecf8e1.jpg) {kaal}", link_preview=True)
    if x == 11:
